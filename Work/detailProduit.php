...
<div class="container py-5">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <img src="<?php echo htmlspecialchars($produit['Image']); ?>" class="img-fluid" alt="<?php echo htmlspecialchars($produit['name']); ?>">
        </div>
        <div class="col-md-6">
            <h1><?php echo htmlspecialchars($produit['name']); ?></h1>
            <p><?php echo nl2br(htmlspecialchars($produit['description'])); ?></p>
            <h3>Prix: <?php echo htmlspecialchars($produit['price']); ?> €</h3>
            <?php if (isset($product['idu'])) {
                    echo '<a href="startChat.php?seller_id=' . htmlspecialchars($product['idu']) . '" class="btn btn-primary">Contacter le vendeur</a>';
            }?>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-3">
            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('<?php echo htmlspecialchars($product['Image']); ?>'); background-size: cover;">
